...
export const contactToMarkdown = (
  userInfo: string,
  contactInfo: z.infer<typeof contactSchema>,
) => {
...
export const projectsToMarkdown = (
  ...
  const mdArray = projects.map((project) => {
    ...
    const githubLink = project.github
      ? `**GitHub:** [Code](${project.github}) ◦`
      : "";
    const liveLink = project.liveLink
      ? `**Live Link:** [Try it out](${project.liveLink})`
      : "";
...
export const educationToMarkdown = (
